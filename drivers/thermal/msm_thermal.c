...
module_param_named(limit_temp_degC, msm_thermal_info.limit_temp_degC, int, 0664);
			
module_param_named(temp_hysteresis_degC,  msm_thermal_info.temp_hysteresis_degC, int, 0664);
...
module_param_named(core_temp_hysteresis_degC, msm_thermal_info.core_temp_hysteresis_degC, int, 0664);
...
module_param_named(hotplug_temp, msm_thermal_info.hotplug_temp_degC,   uint, 0644);

module_param_named(hotplug_temp_hysteresis,  msm_thermal_info.hotplug_temp_hysteresis_degC, uint, 0644);
