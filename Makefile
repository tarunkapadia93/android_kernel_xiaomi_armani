...
PATCHLEVEL = 4
SUBLEVEL = 0
EXTRAVERSION =_nameless_rom_n-2.1_
...
ARCH		?= arm
CROSS_COMPILE	?= ~/toolchains/arm-eabi-5.1/bin/arm-eabi-
...
KERNELFLAGS	= -munaligned-access -fforce-addr -fsingle-precision-constant -mtune=cortex-a7 -marm -mfpu=neon-vfpv4 -fgcse-las
...
KBUILD_CFLAGS   := -Wall -DNDEBUG -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   -mtune=cortex-a7 -mfpu=neon-vfpv4 -marm \
