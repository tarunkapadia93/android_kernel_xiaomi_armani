...
// wcd9306 functions
extern unsigned int tapan_read(struct snd_soc_codec *codec,
				unsigned int reg);
extern int tapan_write(struct snd_soc_codec *codec, unsigned int reg,
	unsigned int value);
extern int tapan_write_no_hook(struct snd_soc_codec *codec, unsigned int reg,
	unsigned int value);
